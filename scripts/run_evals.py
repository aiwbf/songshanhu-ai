...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the admissions eval regression suite.")
    parser.add_argument(
        "--dataset",
        default=str(ROOT / "evals" / "datasets" / "core_regression.json"),
    ...
    json_path = report_dir / "latest_eval_report.json"
    markdown_path = report_dir / "latest_eval_report.md"
